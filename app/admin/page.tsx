...
import UploadCompetitionModal from '@/components/UploadCompetitionModal';
...
export default function AdminPage() {
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <UploadCompetitionModal
        isOpen={showCompetitionUploadModal}
        onClose={() => setShowCompetitionUploadModal(false)}
